...
void AddControls(HWND hWnd)
{
	...
	for (int i = 0; i < 12; i++)
	{
		hWord[1] = CreateWindowW(L"Edit", L"", WS_VISIBLE | WS_CHILD | WS_BORDER, 246, handleYpos, 20, 20, hWnd, NULL, NULL, NULL);
		handleYpos += 20;
	}
	...
	for (int i = 12; i < 24; i++)
	{
		hWord[1] = CreateWindowW(L"Edit", L"", WS_VISIBLE | WS_CHILD | WS_BORDER, 566, handleYpos, 20, 20, hWnd, NULL, NULL, NULL);
		handleYpos += 20;
	}
